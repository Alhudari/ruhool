...
import { Settings, Key, Palette, Languages, Shield, HardDrive, FileText, DollarSign, Bell, CheckCircle, CheckSquare, Globe, Mic, Mic2, Clock, Network, Users, BookOpen, Mail } from 'lucide-react';
